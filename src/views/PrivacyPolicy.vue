<template>
  <div
    class="bg-white w-75 mt-5 p-5 m-auto d-flex justify-content-center align-items-center"
  >
    <div>
      ...
      <p class="mt-2">
        ...
        podrán ser cancelados en cualquier momento. Cthulhu Editorial está
        ...
        nuestros servicios. Enlaces a Terceros Este sitio web pudiera contener
        en laces a otros sitios que pudieran ser de su interés. Una vez que
        usted de clic en estos enlaces y abandone nuestra página, ya no tenemos
        ...
        datos en esos otros sitios terceros. Dichos sitios están sujetos a sus
        ...
        sea requerido por un juez con un orden judicial. Cthulhu Editorial Se
