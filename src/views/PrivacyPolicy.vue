<template>
  <div class="bg-white w-75 mt-5 p-5 m-auto">
    <div>
      <h1>POLÍTICA DE PRIVACIDAD</h1>
      <p class="mt-2">
        La presente Política de Privacidad establece los términos en que Cthulhu
        Editorial usa y protege la información que es proporcionada por sus
        usuarios en el momento de utilizar su sitio web. Esta compañía está
      ...
      <p>
        Nuestro sitio web podrá recoger información personal. Entre otros, dicha
        información podría incluir: nombre, información de contacto como su
        dirección de correo electrónico, e información demográfica. Cuando fuere
        necesario podrá ser requerida información específica para procesar algún
      ...
      <p>
        ...
        usuarios, de pedidos en caso de que esto aplique, y mejorar nuestros
      ...
      <p>
        Cthulhu Editorial está altamente comprometido para cumplir con el
      ...
      <p>
        ...
        navegadores aceptan cookies automáticamente, pues esto sirve para tener
        un mejor servicio web. También usted puede cambiar la configuración de
        su ordenador para declinar las cookies. Si se declinan es posible que no
      ...
      <p>
        ...
        de su interés. Una vez que usted dé clic en estos enlaces y abandone
      ...
      <p>
        Cthulhu Editorial se reserva el derecho de cambiar los términos de la
